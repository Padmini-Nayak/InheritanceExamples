...
public class TestCheckBoxElementsMain {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement option1Element = driver.findElement(By.id("vfb-6-0"));
		...
		WebElement option2Element = driver.findElement(By.id("vfb-6-1"));
		...
		WebElement option3Element = driver.findElement(By.id("vfb-6-2"));
